...
namespace Phoenix::LDS
{
    ...
    struct PHOENIX_LDS_API LDSObjectPtrBase;
    ...
    struct PHOENIX_LDS_API LDSObjectRefPtrBase;
    ...
    struct PHOENIX_LDS_API LDSValuePtrBase;
    ...
    struct PHOENIX_LDS_API LDSEnumFlagsPtrBase;
    ...
    struct PHOENIX_LDS_API LDSArrayPtrBase;
    ...
    struct PHOENIX_LDS_API LDSObjectArrayPtrBase;
    ...
    struct PHOENIX_LDS_API LDSObjectRefArrayPtrBase;
    ...
    struct PHOENIX_LDS_API LDSValueArrayPtrBase;
    ...
    struct PHOENIX_LDS_API LDSEnumTypeItemPtr;
    struct PHOENIX_LDS_API LDSEnumTypePtr;
}