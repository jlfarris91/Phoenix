...
{
    struct PHOENIX_SIM_API LDSObjectArrayPtrBase : LDSArrayPtrBase
    {
    ...
    struct PHOENIX_SIM_API LDSObjectArrayPtr : LDSObjectArrayPtrBase
    {
...
#include "Phoenix.Sim/LDS/ObjectModel/LDSObjectArrayPtr.inl"