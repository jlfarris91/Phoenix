#include "PhoenixSteering/ScriptBindings.h"
...
void ScriptBindings::Describe(ScriptModuleBuilder& builder) const
{
    builder
        ...
        .Function("TurnToFaceEntity(world, entity, target)",      static_cast<bool(*)(WorldRef, ECS::EntityId, ECS::EntityId)>(&FeatureSteering::TurnToFace))
        .Function("TurnToFacePos(world, entity, target)",         static_cast<bool(*)(WorldRef, ECS::EntityId, ECS::EntityId)>(&FeatureSteering::TurnToFace))
