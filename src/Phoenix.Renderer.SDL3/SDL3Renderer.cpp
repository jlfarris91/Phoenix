...
{
    SDL3Renderer::SDL3Renderer(std::shared_ptr<SDL3Context>         context,
    ...
    void SDL3Renderer::DrawSprite(const SceneView& view, const Sprite2DCall& call)
    {
        ...
        SDL_RenderTextureRotated(Context->GetRenderer(), texture, &src, &dst, angleDeg, nullptr, SDL_FLIP_NONE);
    }
    ...
    void SDL3Renderer::DrawMesh(const SceneView& view, const Mesh2DCall& call)
    {
        ...
        SDL_RenderGeometry(Context->GetRenderer(), texture,
