...
namespace Phoenix
{
    ...
    public:
        ...
        std::shared_ptr<IServiceLocator> CreateChildScope() override;
    ...
    // Mixin for classes that own a service locator and want to expose IServiceLocator.
    class ServiceContainerOwner : public IServiceLocator
    {
    public:
        const std::shared_ptr<IServiceLocator>& GetServiceLocator() const;
    ...
    protected:
        std::shared_ptr<IServiceLocator> Container;
    };
}
