...
namespace Phoenix
{
    namespace Profiling
    {
        struct PHOENIX_SIM_API SourceLocation
        {
            const char* Name;
            const char* Function;
            const char* File;
        ...
        PHOENIX_SIM_API bool HasProfiler();
        PHOENIX_SIM_API IProfiler& GetProfiler();
        PHOENIX_SIM_API void SetProfiler(IProfiler* profiler);
